                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text" style={{ fontSize: "smaller" }}>{v.description.slice(0, 80)}...</p>
                                <p className="card-text"><small className="text-body-secondary">{v.published_time}</small></p>
                            </div>
                        </div>
                    </div>
                </div>
